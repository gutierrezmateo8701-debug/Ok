...
-- ========================================================
-- SISTEMA DE NOTIFICACIONES (TAMAÑO DINÁMICO)
-- ========================================================
function Rayfield:Notify(Config)
    ...
    NotifFrame.AutomaticSize = Enum.AutomaticSize.Y -- Redimensionado automático
    ...
    ContentLabel.AutomaticSize = Enum.AutomaticSize.Y -- Expande si el texto es largo
...
-- ========================================================
-- CREACIÓN DE VENTANA PRINCIPAL (CON KEYSYSTEM & AJUSTES)
-- ========================================================
function Rayfield:CreateWindow(Config)
    ...
    -- Contenedor de Pestañas (Barra Lateral o Superior)
    ...
    -- ----------------------------------------------------
    -- PESTAÑA PREDETERMINADA AUTOMÁTICA: "AJUSTES"
    -- ----------------------------------------------------
